package LinkedListofE;

//A LinkedList object can be used to store a list of objects.
public class LinkedList<E> {
 ...
 private LinkedList(String name, ListNode front) {
     this.name  = name;
     this.front = front;
 }
 ...
 // node class is for a list of values.
 ...
 private final java.util.List<ListNode> ALL_NODES = new java.util.ArrayList<ListNode>();
